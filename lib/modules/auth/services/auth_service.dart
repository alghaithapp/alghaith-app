...
class AuthService extends ChangeNotifier {
  ...
  Future<void> _restoreRemoteSession(
    ...
    try {
      ...
      if (bundle.driverProfile != null &&
          bundle.driverProfile!.isNotEmpty &&
          _onApplyDriverProfile != null) {
        _onApplyDriverProfile!(bundle.driverProfile!);
      }
      if (bundle.courierProfile != null &&
          bundle.courierProfile!.isNotEmpty &&
          _onApplyCourierProfile != null) {
        _onApplyCourierProfile!(bundle.courierProfile!);
      }
  ...
  Map<String, dynamic> Function()? _onCollectUiState;
  void setOnCollectUiState(Map<String, dynamic> Function() cb) =>
      _onCollectUiState = cb;
  ...
  Map<String, dynamic> _buildRemoteState() {
    if (_onCollectUiState != null) {
      return _onCollectUiState!();
    }
    return const {};
  }
