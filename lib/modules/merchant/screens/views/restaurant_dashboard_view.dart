    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Color(0xFF2E150C), Color(0xFF1F0F0B), Color(0xFF3F1B0F)],
