...
class _TaxiCustomerAccountScreenState extends State<TaxiCustomerAccountScreen> {
  ...
  Future<void> _pickAvatar(AppProvider app) async {
    ...
    try {
      final url = await app.uploadImage(File(picked.path));
      if (url != null && url.isNotEmpty) {
        await app.updateCustomerProfile(avatarBase64: url);
      }
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    final avatar = app.customerAvatarBase64;
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        onTap: _isUploadingPhoto ? null : () => _pickAvatar(app),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'الصورة اختيارية — تظهر للكابتن عند طلبك',
                      style: TextStyle(
                        fontFamily: 'Cairo',
                        fontSize: 11,
                        color: Colors.grey.shade500,
