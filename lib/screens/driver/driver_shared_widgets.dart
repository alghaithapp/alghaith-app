...
/// A full card showing a taxi request with action buttons.
class DrvTaxiCard extends StatelessWidget {
...
/// A compact preview of a taxi request.
class DrvTaxiPreview extends StatelessWidget {
  final TaxiRequest request;

  const DrvTaxiPreview({
    super.key,
    required this.request,
  });
