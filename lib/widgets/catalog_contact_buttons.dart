  ...
  Widget build(BuildContext context) {
    ...
    return InternalContactButtons.store(
      ...
      storeName: item.merchantStoreName?.trim().isNotEmpty == true
          ...
          : item.nameAr,
      merchantProfile: {
        if (item.merchantOpenTime != null) 'open_time': item.merchantOpenTime,
        if (item.merchantCloseTime != null) 'close_time': item.merchantCloseTime,
        'is_open': item.merchantIsOpen ?? true,
      },
